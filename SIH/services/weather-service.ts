...
const API_KEY = "d4306e31cc1e44d6059bae0f95107841";
  ...
  try {
    ...
    forecastData.list.forEach((item: any) => {
      ...
      if (!processedDates.has(date)) {
        ...
        } else if (!dailyForecasts.find((f: any) => new Date(f.dt * 1000).toLocaleDateString() === date)) {
    ...
    const uniqueForecasts = dailyForecasts.filter((item, index, self) => 
...
const getMockWeatherData = (): WeatherData => {
    return {
        ...
        forecast: [
            { dt: 1694486400, temp: 29, temp_min: 22, temp_max: 29, condition: "Clouds", icon: "02d", date: "Tue" },
            { dt: 1694572800, temp: 27, temp_min: 21, temp_max: 27, condition: "Rain", icon: "10d", date: "Wed" },
            { dt: 1694659200, temp: 26, temp_min: 20, temp_max: 26, condition: "Rain", icon: "10d", date: "Thu" },
            { dt: 1694745600, temp: 28, temp_min: 21, temp_max: 28, condition: "Clear", icon: "01d", date: "Fri" },
            { dt: 1694832000, temp: 29, temp_min: 22, temp_max: 29, condition: "Clouds", icon: "03d", date: "Sat" },
        ]
    };
};
